...
def main():
    ...
    # Define the quiz cell categories, to match canvas quiz cell type to the cell number. Format: quiz_number: cell_number
    quiz_cell_category = {
        1: 15, 2: 15, 3: 15, 4: 15,
    ...
    for user_id in user_ids:
        ...
        print("familiarity_array", familiarity_array)
